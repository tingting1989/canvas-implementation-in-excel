/** 空值类型常量键 */
type NullValueTypeKey = "blank" | "emptyString" | "null" | "undefined";

/** 空值类型常量映射 */
interface NullValueTypeMap {
    BLANK: NullValueTypeKey;
    EMPTY_STRING: NullValueTypeKey;
    NULL: NullValueTypeKey;
    UNDEFINED: NullValueTypeKey;
}
 ...
 *
 * @module plugins/filter/NullValueTypes
 */
export const NULL_VALUE_TYPES: NullValueTypeMap = {
    BLANK: "blank",
...
export class NullValueHandler {
    /** UI 上显示的空白单元格文本 */
    static BLANK_DISPLAY: string = "(空白)";

    /** 统一表示所有空值的键（用于筛选唯一值存储） */
    static NULL_KEY: string = "__EXCEL_NULL__";
     ...
     *
     * @param value - 待检测的值
     * @returns 空值类型，或 null（非空值）
     */
    static getNullType(value: any): NullValueTypeKey | null {
     ...
     */
    static normalizeToKey(value: any): string {
     ...
     * @returns 是否为纯空白
     */
    static isBlankOnly(value: any): boolean {
