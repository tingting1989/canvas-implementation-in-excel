...
import { AutoFillPlugin } from "@/plugins/autoFill/AutoFillPlugin.ts";
import { AutoFillStrategy } from "@/plugins/autoFill/AutoFillStrategy.ts";
...
describe("AutoFillPlugin", () => {
    ...
    beforeEach(() => {
        ...
        plugin = new AutoFillPlugin(workbook);
    });

    describe("Constructor & Static Properties", () => {
        it("should have correct PLUGIN_NAME", () => {
            expect(AutoFillPlugin.PLUGIN_NAME).toBe("autoFill");
        });
    ...
    describe("init()", () => {
        ...
        it("should register autoFill strategy", () => {
            plugin.init();
    ...
    describe("destroy()", () => {
        ...
        it("should remove registered strategy", () => {
            ...
            expect(workbook.eventHandler.removeStrategy).toHaveBeenCalledWith("autoFill");
        });
    });
});